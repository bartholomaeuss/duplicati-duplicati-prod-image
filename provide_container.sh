...
provide_container(){
    ...
    ssh -l "${user}" "${remote}" "docker run -d --net=host -v ~/duplicati:/duplicati -v ~/backup:/backup -v /mnt/external_drive/tier2://mnt/external_drive/tier2 -v /mnt/external_ssdrive/tier2:/mnt/external_ssdrive/tier2 -v /mnt/external_drive/tier3://mnt/external_drive/tier3 -v /mnt/external_ssdrive/tier3:/mnt/external_ssdrive/tier3 --restart=unless-stopped ${image}:${tag}"
    exit 0
}
