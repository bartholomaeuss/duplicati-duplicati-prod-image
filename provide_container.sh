...
provide_container(){
    ...
    ssh -l "${user}" "${remote}" "docker run -d --net=host -v ~/duplicati:/duplicati -v /mnt/external_drive_1/tier2:/external_drive_1/tier2 -v /mnt/external_drive_2/tier2:/external_drive_2/tier2 -v /mnt/external_drive_1/tier3:/external_drive_1/tier3 -v /mnt/external_drive_2/tier3:/external_drive_2/tier3 --restart=unless-stopped ${image}:${tag}"
    exit 0
}
